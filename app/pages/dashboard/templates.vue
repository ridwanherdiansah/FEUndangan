    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        <div
          ...
          class="absolute -top-3 -right-3 bg-rose-600 text-white px-4 py-1 z-10 text-[10px] font-black uppercase tracking-widest italic"
        >
          HOT
        </div>
        ...
        <div class="relative aspect-[3/4] overflow-hidden border-b-2 border-black bg-gray-100">
          ...
          />
          <div
            class="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-6"
          >
            <NuxtLink
        ...
        <div class="p-6">
          <div class="flex justify-between items-start mb-4">
            ...
            <span class="text-[10px] font-black border-2 border-black px-2 py-1"> FREE </span>
          </div>
